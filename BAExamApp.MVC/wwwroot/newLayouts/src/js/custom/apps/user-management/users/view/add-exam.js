                ...
                fields: {
                    'ExamDateTime': {
                        validators: {
                            ...
                            ,
                            callback: {
                                message: localizedTexts.examDateTimeInvalidText,
                    ...
                    'ExamType': {
                        validators: {
                            notEmpty: {
                                message:localizedTexts.examTypeRequiredText
                            }
                        }
                    },
                    'ExamRuleId': {
                        validators: {
                            notEmpty: {
                                message: localizedTexts.examRuleRequiredText
                            }
                        }
                    },
                    'ExamCreationType': {
                        validators: {
                            notEmpty: {
                                message: localizedTexts.examCreationTypeRequiredText
                            }
                        }
                    },
                    'ExamClassroomsIds': {
                        validators: {
                            notEmpty: {
                                message: localizedTexts.examClassroomsRequiredText
                            }
                        }
                    },
                    'Description': {
