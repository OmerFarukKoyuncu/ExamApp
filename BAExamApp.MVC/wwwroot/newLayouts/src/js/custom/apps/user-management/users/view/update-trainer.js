...
console.log(validationMessages.FirstNameRequired);
console.log(validationMessages.PictureSize);
console.log(validationMessages.LastNameRequired);
console.log(validationMessages.EmailRequired);
...
var KTUsersUpdateDetails = function () {
    ...
    var initUpdateDetails = () => {
                    ...
                    'NewImage': {
                        validators: {
                            file: {
                                ...
                                maxSize: 262144, // 256 kb PictureSize
                                message: validationMessages.PictureSize
                            }
                        }
                    },
                    'FirstName': {
        ...
        closeButton.addEventListener('click', e => {
            ...
            var tooltips = document.querySelectorAll('[data-bs-toggle1="tooltip"]');

            tooltips.forEach(function (tooltipElement) {
                // Eğer tooltip aktifse, hide metoduyla gizleyelim
                var tooltip = bootstrap.Tooltip.getInstance(tooltipElement);
                if (tooltip) {
                    tooltip.hide(); // Tooltip'i gizle
                }
            });
