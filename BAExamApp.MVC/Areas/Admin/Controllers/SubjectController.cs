...
public class SubjectController : AdminBaseController
{
    ...
    public async Task<IActionResult> Details(Guid id)
    {
        ...
        subjectDto.Data.Subtopics?.RemoveAll(x => x.Status == Status.Deleted || x.Status == Status.Passive);
    ...
    [HttpGet]
    public async Task<IActionResult> SearchSubjectAutocomplete(string term)
    {
