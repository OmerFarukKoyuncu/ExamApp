...
public interface IDashboardService
{
    ...
    /// </returns>
    Task<IDataResult<List<DashboardTrainerQuestionDto>>> GetWaitedRevisedApprovedQuestionByTrainerIdAsync(
    ...
    Task<IDataResult<List<QuestionListDto>>> GetTopTenByAwaitedQuestionAsync(int takeCount);
    ...
    /// <param name="takeCount">Alınacak soru sayısı.</param>
    /// <returns>Başarılı bir şekilde alınan soruları içeren bir IDataResult döndürür.</returns>
    Task<IDataResult<List<QuestionListDto>>> GetTopTenByReviewedQuestionAsync(int takeCount);
}
