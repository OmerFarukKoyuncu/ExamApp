...
public interface IStudentExamService
{
    ...
    /// <summary>
    /// Belirtilen öğrenci kimliğine (ID) ait sınav kayıtlarını listeler. 
    /// Dönüş değeri, işlem sonucunu ve sınav bilgilerini içeren bir veri nesnesidir.
    /// </summary>
    Task<IDataResult<List<StudentsExamsDto>>> GetExamListByStudentIdAsync(Guid id);
}
