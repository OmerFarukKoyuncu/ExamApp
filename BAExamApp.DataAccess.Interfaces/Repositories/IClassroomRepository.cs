...
public interface IClassroomRepository : IAsyncRepository, IAsyncQueryableRepository<Classroom>, IAsyncFindableRepository<Classroom>, IAsyncUpdateableRepository<Classroom>, IAsyncInsertableRepository<Classroom>, IAsyncDeleteableRepository<Classroom>,IAsyncPaginateRepository<Classroom>
{
    /// <summary>
    ...
    Task<IEnumerable<Classroom>> GetClassroomsForAutoCompleteAsync(string term);
}
